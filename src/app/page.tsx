...
export default async function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-between h-screen w-screen p-4 gap-2 divide-y divide-solid divide-black dark:divide-white font-[family-name:var(--font-geist-sans)]'>
