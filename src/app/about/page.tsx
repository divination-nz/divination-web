    ...
    <main className='flex w-full flex-col items-start justify-start overflow-y-scroll lg:px-48'>
      ...
      <div className='flex flex-col gap-1 overflow-y-scroll sm:gap-2'>
        <p className='text-left text-text'>
          ...
          <br />
          <br />
          Created to help you and your friends find the rules you need before
          the next untap step. Created to help judges make the calls they need
        ...
        <p>
          ...
          Coast, LLC. The Comprehensive Rules presented in whole or part on this
          site are the sole property of Wizards of the Coast, LLC, and are not
          produced or modified by Divination. Divination is not produced by or
          endorsed by Wizards of the Coast.
        </p>
        <blockquote className='mt-2 italic text-lavender'>
          “Half of your studies will be learning the laws of magic. The other
          half will be bending them.” —Naru Meha, master wizard
        </blockquote>
      </div>
    </main>
  );
